...
internal/
  ...
  skills/
    ...
    secrets.go         # SecretsStore: per-skill API key CRUD + plaintext index file
    secrets_darwin.go  # macOS Keychain ops via /usr/bin/security CLI
    secrets_other.go   # non-darwin stub (returns error)
